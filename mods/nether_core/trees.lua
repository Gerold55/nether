...
function core.grow_new_emergent_jungle_tree(pos)
	local path = minetest.get_modpath("core") ..
...
function core.grow_new_pine_tree(pos)
	...
	if math.random() > 0.5 then
		path = minetest.get_modpath("core") ..
...
function core.grow_blueberry_bush(pos)
	local path = minetest.get_modpath("core") ..
...
function core.grow_pine_bush(pos)
	local path = minetest.get_modpath("core") ..
...
function core.grow_large_cactus(pos)
	local path = minetest.get_modpath("core") ..
